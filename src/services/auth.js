...
import { AT_TERM, RT_TERM, SMTP, TEMPLATES_DIR } from '../constants/index.js';
...
//оновлення паролю
export const resetPswrd = async (payload) => {
  let entries;
  ...
  const encryptedPswrd = await bcrypt.hash(payload.password, 10);
